...
const IndoorEnvPage = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-gray-800 text-white min-h-screen p-4">
      <main className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-4 w-full mt-4">
        ...
        <div className="col-span-1 md:col-span-3 lg:col-span-3 row-span-2 relative flex justify-center items-center bg-white">
        ...
        <div className="col-span-1 md:col-span-2 lg:col-span-2 xl:col-span-1 row-span-1">
